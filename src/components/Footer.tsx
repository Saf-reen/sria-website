...
const Footer: React.FC = () => {
  ...
  return (
    <div className="bg-black w-100% text-white font-[Questrial,Arial,Verdana,Tahoma,sans-serif]">
      <footer className="bg-black text-white px-4 md:px-10 xl:px-20 py-10 text-sm max-w-[1400px] mx-auto overflow-hidden">
        ...
        <div className="mt-3 w-full mb-16 flex  justify-between">
          <div
            className="py-5 px-2 w-full flex justify-between "
            style={{
              background: `linear-gradient(90deg, rgb(34, 34, 34) 0%, rgb(24, 24, 24) 55.5%, rgb(34, 34, 34) 100%)`,
            }}
          >
            <div className="flex w-full flex-row justify-between p-4 mx-auto">
