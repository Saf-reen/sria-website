...
const FeatureTabs: React.FC<FeatureTabsProps> = ({ features }) => {
 ...
 <div className="flex flex-col md:flex-row p-8 rounded-lg">
  {/* Left - Tabs */}
  <div className="w-full md:w-1/3 relative" id="left-column">
  ...
  {/* Right - Image */}
  <div className="w-full md:w-2/3 mt-6 md:mt-0 md:pl-10 flex justify-center">
    <div className="w-full h-full max-h-full flex items-center">
      <img
