                ...
                <div className="w-full lg:w-5/6 bg-white min-h-screen p-4 lg:p-6">
                    ...
                    <section id="overview" className="scroll-mt-24">
                        ...
                        <p className="mt-8 sm:mt-12 text-lg sm:text-xl md:text-2xl w-full lg:w-3/4 text-gray-500">
                            Nxify is a comprehensive cloud-based platform designed to simplify and automate employee financial operations, HR processes, and EXIM workflows. From payroll, IT declarations, and loans to attendance tracking, onboarding, and exit processes, Nxify unifies everything under one intelligent system with real-time dashboards and analytics.
  ...
                />        </div>
                    ...
                    <section id="key-features" className="mt-16 sm:mt-20 scroll-mt-24">
                        <div className="w-full lg:w-3/4">
                            ...
                            <p className="mt-4 text-lg sm:text-xl md:text-2xl text-gray-500">
                                   Nxify's intelligent automation covers payroll, IT declarations, employee loans, attendance tracking, onboarding, exit processes, and seamless EXIM solutions—all integrated, customizable, and available anywhere via the cloud.
                    ...
                    <section id="benefits" className="mt-16 sm:mt-20 w-full scroll-mt-24">
                        ...
                        <p className="mt-4 text-lg sm:text-xl md:text-2xl w-full lg:w-3/4 text-gray-500">
                                Nxify enhances HR and financial management by automating repetitive tasks, ensuring real-time visibility, and delivering scalable, compliance-ready workflows for enterprises of any size.
                    ...
                    >
                        <div className="bg-black w-full p-4 lg:p-10 text-white rounded-lg">
                            ...
                            <p className="mt-6 text-base sm:text-lg lg:text-xl w-full lg:w-3/4 text-white leading-relaxed">
                                Streamline employee financials, payroll, IT declarations, and HR operations with Nxify. Gain complete control, compliance, and clarity—while empowering your teams through automation and real-time insights.     </p>
                        </div>
                    </section>
