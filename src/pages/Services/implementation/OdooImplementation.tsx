    ...
    <div className="w-full relative overflow-x-hidden lg:overflow-x-visible">
      <div className="scroll-smooth w-full relative ">
        ...
        <ImageOverlay
          ...
          description="Optimize your business operations with our Odoo Implementation Services. We deliver end-to-end ERP deployment, customization, and integration tailored to your industry needs."
        />
            ...
            <div className="flex flex-col md:flex-row justify-between gap-8 mb-10">
              <div className="w-full md:w-1/2">
                <h1 className="text-[47px]  leading-tight">
                  Streamline Your Business with Sria Infotech’s Odoo Implementation Services
                </h1>
              </div>
              <div className="w-full md:w-1/2">
                <p className="text-base md:text-lg leading-relaxed">
                  In today’s fast-paced business environment, the ability to integrate and automate operations is critical for growth and efficiency. As a leading Odoo implementation partner, Sria Infotech offers comprehensive ERP solutions tailored to your unique business needs. Our services ensure a smooth deployment, customization, and integration of Odoo, enabling your organization to operate more efficiently, reduce costs, and achieve data-driven decision-making with ease.
                </p>
              </div>
            </div>
