      ...
      <div className="scroll-smooth w-full relative ">
        ...
        <div className=" relative  sticky top-0 z-20   bg-white ">
          <div className="  flex flex-col lg:flex-row w-full max-w-[1400px] mx-auto ">
           ...
           <StatCardStable
  percentage="40%"
  description="Reduction in transactional time using Fiori apps over traditional SAP GUI."
/>
<StatCardStable
  percentage="60%"
  description="Increase in user adoption due to simplified UI/UX design."
/>
<StatCardStable
  percentage="70%"
  description="Improved task efficiency for field workers via mobile-first Fiori apps."
/>
                  </div>
                </div>
              </section>
