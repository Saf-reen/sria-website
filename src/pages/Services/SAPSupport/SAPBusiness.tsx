          ...
          <div className="  flex flex-col lg:flex-row w-full max-w-[1400px] mx-auto ">
            ...
            <div className="w-full lg:w-5/6 min-h-screen p-2">
              ...
              <section id="insights" className="scroll-mt-24 py-16 bg-white">
                ...
                <StatCardStable
  percentage="70%"
  description="Reduction in development time using low-code tools within BTP."
/>
<StatCardStable
  percentage="90%"
  description="Improved data access efficiency across hybrid landscapes."
/>
<StatCardStable
  percentage="50%"
  description="Faster decision-making through real-time analytics in SAP BTP."
/>
                  </div>
                </div>
              </section>
