...
const sapData = {
  ...
  imageUrl: "/Solutions/sales-cloud.webp",
...
const features = [
  {
    ...
    description:
      "Leverage machine learning to predict revenue, spot risks early, and optimize closing strategies.",
    image: "/SalesCloud/forecasting.png",
  },
  {
    title: "Guided Selling & Recommendations",
    description:
      "Suggest next best actions, cross-sell and up-sell suggestions personalized by account context.",
    image: "/SalesCloud/guided-selling.png",
  },
  {
    title: "CPQ Automation",
    description:
      "Streamline quotes with product rules, pricing logic, and approval workflows for faster deal cycles.",
    image: "/SalesCloud/cpq.png",
  },
  {
    title: "Mobile-First CRM",
    description:
      "Sell on the go with full CRM capabilities—contacts, activities, opportunity updates—from your phone.",
    image: "/SalesCloud/mobile-crm.png",
  },
  {
    title: "Commission & Incentive Management",
    description:
      "Manage commissions, incentives, and payouts seamlessly—aligned to performance metrics.",
